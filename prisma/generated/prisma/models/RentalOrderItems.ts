...
// @ts-nocheck 
/*
 * This file exports the `RentalOrderItems` model and its related types.
 *
...
export type GetRentalOrderItemsAggregateType<T extends RentalOrderItemsAggregateArgs> = {
      [P in keyof T & keyof AggregateRentalOrderItems]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateRentalOrderItems[P]>
    : Prisma.GetScalarType<T[P], AggregateRentalOrderItems[P]>
}
...
export type GetRentalOrderItemsGroupByPayload<T extends RentalOrderItemsGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<RentalOrderItemsGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof RentalOrderItemsGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], RentalOrderItemsGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], RentalOrderItemsGroupByOutputType[P]>
      }
    >
  >
...
export type RentalOrderItemsCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<RentalOrderItemsFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface RentalOrderItemsDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['RentalOrderItems'], meta: { name: 'RentalOrderItems' } }
  /**
   ...
   * })
  **/
  count<T extends RentalOrderItemsCountArgs>(
    args?: Prisma.Subset<T, RentalOrderItemsCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], RentalOrderItemsCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends RentalOrderItemsGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, RentalOrderItemsGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetRentalOrderItemsGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
