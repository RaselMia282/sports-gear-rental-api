...
export type GetGearItemAggregateType<T extends GearItemAggregateArgs> = {
    [P in keyof T & keyof AggregateGearItem]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateGearItem[P]> : Prisma.GetScalarType<T[P], AggregateGearItem[P]>;
};
...
export type GetGearItemGroupByPayload<T extends GearItemGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<GearItemGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof GearItemGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], GearItemGroupByOutputType[P]> : Prisma.GetScalarType<T[P], GearItemGroupByOutputType[P]>;
}>>;
export type GearItemWhereInput = {
    ...
    availableQuantity?: Prisma.IntFilter<"GearItem"> | number;
...
export type GearItemScalarWhereWithAggregatesInput = {
    ...
    availableQuantity?: Prisma.IntWithAggregatesFilter<"GearItem"> | number;
...
export type GearItemOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "title" | "description" | "brand" | "stockQuantity" | "pricePerDay" | "availableQuantity" | "createdAt" | "updatedAt" | "providerId" | "categoryId", ExtArgs["result"]["gearItem"]>;
...
export type GearItemCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<GearItemFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface GearItemDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['GearItem'];
        meta: {
            name: 'GearItem';
        };
    };
     ...
     * })
    **/
    count<T extends GearItemCountArgs>(args?: Prisma.Subset<T, GearItemCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], GearItemCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends GearItemGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, GearItemGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetGearItemGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface GearItemFieldRefs {
    ...
    readonly availableQuantity: Prisma.FieldRef<"GearItem", 'Int'>;
...
//# sourceMappingURL=GearItem.d.ts.map