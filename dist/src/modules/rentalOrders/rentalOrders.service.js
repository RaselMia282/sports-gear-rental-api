...
const createRentalOrderIntoDB = async (payload, customerId) => {
    ...
    if (gear.availableQuantity < quantity) {
        throw new AppError(400, `Requested quantity (${quantity}) exceeds available stock (${gear.availableQuantity})!`);
    }
...
const userRentalIntoDb = async (customerId) => {
...
const rentalOrderDetailsIntoDb = async (orderId, userId, role) => {
...
//# sourceMappingURL=rentalOrders.service.js.map